    ...
    return (
        <section className="flex flex-col gap-8 w-full font-Outfit mb-20 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold text-[#333333]">Single Verification</h1>
            ...
            <div className="bg-white border border-[#e6e6e7] rounded-[32px] p-10 shadow-sm flex flex-col gap-10">
                ...
                <div className="grid grid-cols-2 gap-x-10 gap-y-8">
                    <div className="flex flex-col gap-2.5">
                        ...
                        <input 
                            ...
                            className="w-full bg-[#fcfcfc] border border-[#f2f2f3] rounded-2xl h-14 px-6 focus:outline-none focus:ring-2 focus:ring-[#ff895d]/20 transition-all text-[#333333] font-medium placeholder:text-[#bebebe]"
                        />
                    </div>
                    <div className="flex flex-col gap-2.5">
                ...
                {sections.map((section, index) => (
                    <div key={section.id} className="border border-[#e6f0ff] bg-[#f9fbff]/30 rounded-[24px] p-8 flex flex-col gap-8 relative group">
                        {index > 0 && (
                            <button 
                            ...
                            <div className="grid grid-cols-1 gap-6 animate-in slide-in-from-top-2 duration-300">
                                <div className="flex flex-col gap-2.5">
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-[#f2f2f3] rounded-2xl h-14 px-6 focus:outline-none focus:ring-2 focus:ring-[#ff895d]/20 transition-all text-[#333333] font-medium"
                                    />
                                </div>
                                <div className="flex flex-col gap-2.5">
                        ...
                        {section.type === "Guarantor's Verification" && (
                            <div className="grid grid-cols-2 gap-x-10 gap-y-6 animate-in slide-in-from-top-2 duration-300">
                                <div className="flex flex-col gap-2.5">
                                ...
                                <div className="flex flex-col gap-2.5">
                                    ...
                                    <input type="text" placeholder="+234 |" className="w-full bg-white border border-[#f2f2f3] rounded-2xl h-14 px-6 focus:outline-none" />
                                </div>
                                <div className="flex flex-col gap-2.5">
                                    <label className="text-[14px] font-bold text-[#666666]">Relationship with Candidate</label>
                                    <input type="text" placeholder="Enter relationship" className="w-full bg-white border border-[#f2f2f3] rounded-2xl h-14 px-6 focus:outline-none" />
                                </div>
                                <div className="col-span-2">
                                    <label className="text-[14px] font-bold text-[#666666] flex items-center gap-1.5 mb-3">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <div className="flex items-center justify-between bg-white border border-[#f2f2f3] rounded-2xl p-5 w-full">
                                            <div className="flex items-center gap-4">
                                                <div className="bg-[#e6f0ff] p-2.5 rounded-xl">
                                                    <Download className="text-[#3b82f6]" size={18} />
                                                </div>
                                                <span className="text-[14px] font-bold text-[#333333]">Guarantor's form</span>
                                            </div>
                                            <button className="flex items-center gap-2 text-[#888888] text-xs font-bold hover:text-[#333333]">
                                                <Download size={14} />
                                                Download
                                            </button>
                                        </div>

                                        <div className="border-2 border-dashed border-[#f2f2f3] rounded-[32px] p-10 flex flex-col items-center justify-center gap-4 bg-[#fafafa] hover:border-[#ff895d] transition-all cursor-pointer group/upload">
                                            <div className="bg-white p-4 rounded-2xl shadow-sm group-hover/upload:scale-110 transition-transform">
                                                <Upload className="text-[#bebebe] group-hover/upload:text-[#ff895d]" size={32} />
                                            </div>
                                            <div className="text-center">
                                                <p className="text-sm font-bold text-[#333333]">Click to upload <span className="text-[#888888] font-medium">or drag and drop</span></p>
                                                <p className="text-[11px] text-[#bebebe] mt-1">(PDF, JPG, PNG, tiff or HEIC maximum 10mb)</p>
                                            </div>
                                        </div>
                                    </div>

                                    <button className="flex items-center gap-2 text-[#ff895d] text-sm font-bold mt-4 hover:underline">
                                        <Plus size={16} />
                                        Add more input
                                    </button>
                                </div>
                ...
                <button 
                    onClick={addSection}
                    className="flex items-center gap-3 text-[#ff895d] font-bold text-base hover:opacity-80 transition-opacity w-fit"
                >
                ...
                {/* Submit Button */}
                <button className="w-full bg-[#ff895d] text-white h-16 rounded-[20px] font-bold text-lg shadow-xl shadow-[#ff895d]/20 hover:bg-[#ff7a45] transition-all mt-6 active:scale-[0.98]">
                    Submit
                </button>
            </div>
        </section>
